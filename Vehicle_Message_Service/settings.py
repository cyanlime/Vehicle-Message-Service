"""
Django settings for Vehicle_Message_Service project.
...
SECRET_KEY = 'mfrr&42g1##^3ebae(4+#i9k*4ul%(r&-(t++1ts^8qswdm4fy'
...
ROOT_URLCONF = 'Vehicle_Message_Service.urls'
...
WSGI_APPLICATION = 'Vehicle_Message_Service.wsgi.application'
